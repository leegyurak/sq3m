...
class TestDatabaseAnalyzer:
    ...
    def test_get_tables_with_purposes_no_cached_purposes(
        ...
        assert len(result) == 2
        assert result[0].purpose == "Stores user account information including names and email addresses"  # From fixture
        assert result[1].purpose == "Stores product information including names and prices"  # From fixture