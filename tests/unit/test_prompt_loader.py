...
class TestPromptLoader:
    ...
    def test_init(self, prompt_loader):
    ...
    def test_load_default_system_prompt(self, prompt_loader):
    ...
    def test_load_system_prompt_with_custom_path(self, prompt_loader, temp_dirs):
    ...
    def test_load_system_prompt_with_env_path(self, prompt_loader, temp_dirs):
    ...
    def test_load_system_prompt_with_env_file(self, prompt_loader, temp_dirs):
        ...
        with patch.dict(os.environ, {"SYSTEM_PROMPT_FILE": "env_file_prompt.txt"}):
            with patch('sqlllm.infrastructure.config.env_detector.EnvironmentDetector', return_value=mock_detector):
                prompt = prompt_loader.load_system_prompt()
                
        assert prompt == custom_content

    def test_load_system_prompt_priority_order(self, prompt_loader, temp_dirs):
    ...
    def test_load_system_prompt_env_path_priority(self, prompt_loader, temp_dirs):
    ...
    def test_load_system_prompt_file_not_found_fallback(self, prompt_loader, temp_dirs):
    ...
    def test_load_system_prompt_no_files_error(self, prompt_loader, temp_dirs):
    ...
    def test_create_custom_prompt_template(self, prompt_loader, temp_dirs):
    ...
    def test_create_custom_prompt_template_creates_parent_dir(self, prompt_loader, temp_dirs):
    ...
    def test_get_available_prompts_default_only(self, prompt_loader):
    ...
    def test_get_available_prompts_with_env_vars(self, prompt_loader, temp_dirs):
    ...
    def test_resolve_prompt_path_precedence(self, prompt_loader, temp_dirs):
