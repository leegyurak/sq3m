...
class TestEnvironmentDetector:
    ...
    def test_init_windows(self, mock_home, mock_system, temp_home_dir):
        """Test initialization on Windows."""
        mock_system.return_value = "Windows"
        mock_home.return_value = temp_home_dir
        
        with patch.dict(os.environ, {"APPDATA": str(temp_home_dir / "AppData" / "Roaming")}, clear=False):
    ...
    @patch('platform.system')
    @patch('pathlib.Path.home')
    def test_init_macos(self, mock_home, mock_system, temp_home_dir):
    ...
    @patch('platform.system')
    @patch('pathlib.Path.home')
    def test_init_linux(self, mock_home, mock_system, temp_home_dir):
    ...
    @patch('platform.system')
    @patch('pathlib.Path.home')
    def test_init_linux_with_xdg_config(self, mock_home, mock_system, temp_home_dir):
    ...
    @patch('pathlib.Path.home')
    def test_detect_environment_windows(self, mock_home, mock_python_ver, mock_arch, mock_system, temp_home_dir):
    ...
    @patch('platform.python_version')
    @patch('pathlib.Path.home')
    def test_detect_environment_unix(self, mock_home, mock_python_ver, mock_arch, mock_system, temp_home_dir):
    ...
    @patch('platform.system')
    @patch('pathlib.Path.home')
    def test_create_default_env_file(self, mock_home, mock_system, temp_home_dir):
    ...
    @patch('platform.system')
    @patch('pathlib.Path.home')
    def test_create_default_env_file_exists(self, mock_home, mock_system, temp_home_dir):
    ...
    def test_detect_database_clients(self, mock_which, temp_home_dir):
        ...
        with patch('pathlib.Path.home', return_value=temp_home_dir):
            ...
            clients = detector.detect_database_clients()
            
            assert clients["mysql"] is True
            assert clients["postgresql"] is True

    @patch('shutil.which')
    def test_command_exists_windows(self, mock_which, temp_home_dir):
        ...
        with patch('pathlib.Path.home', return_value=temp_home_dir):
            with patch('platform.system', return_value="Windows"):
                ...
                exists = detector._command_exists("mysql")
                
                assert mock_which.call_count >= 1

    @patch('psutil.virtual_memory')
    @patch('psutil.cpu_count')
    def test_get_recommended_settings_high_performance(self, mock_cpu_count, mock_virtual_memory, temp_home_dir):
        ...
        with patch('pathlib.Path.home', return_value=temp_home_dir):
            ...
            detector = EnvironmentDetector()
            detector.detect_database_clients = Mock(return_value={"mysql": True, "postgresql": False})
    ...
    @patch('psutil.virtual_memory')
    @patch('psutil.cpu_count')
    def test_get_recommended_settings_low_performance(self, mock_cpu_count, mock_virtual_memory, temp_home_dir):
        ...
        with patch('pathlib.Path.home', return_value=temp_home_dir):
            ...
            detector = EnvironmentDetector()
            detector.detect_database_clients = Mock(return_value={})
    ...
    @patch('platform.system')
    @patch('pathlib.Path.home')
    def test_apply_environment_config(self, mock_home, mock_system, temp_home_dir):
