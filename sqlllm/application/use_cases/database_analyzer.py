...
from ...domain.entities.database import Table, DatabaseSchema


class DatabaseAnalyzer:
    def __init__(self, database_repository: DatabaseRepository, llm_service: LLMService):
    ...
    async def _analyze_table_async(self, table: Table) -> Table:
        ...
        try:
            sample_rows = self.database_repository.get_table_sample_rows(table.name, limit=5)
