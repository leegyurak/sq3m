...
class EnvironmentDetector:
    ...
    def _get_config_dir(self) -> Path:
        ...
        if self.system == "windows":
            config_dir = Path(os.getenv("APPDATA", self.home_dir / "AppData" / "Roaming")) / "sqlllm"
    ...
    def create_default_env_file(self) -> Path:
        ...
        if not env_file.exists():
            default_content = f"""# SQLLLM Configuration  
...
"""
    ...
    def get_database_defaults(self, db_type: str) -> Dict[str, str]:
